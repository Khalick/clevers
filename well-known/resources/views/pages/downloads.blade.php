...
@section('content')
    <div class="row d-flex justify-content-evenly mb-4">
        ...
        <div class="col-md-12 col-4 text-end">
            ...
            <a class="btn btn-danger" href="/downloads">
               Clear Search
            </a>
            @endif
            <a  class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#newFile">New Download</a>
...
<div class="dt-responsive table-responsive">
    <table id="cbtn-selectors" class="table table-striped nowrap">
        ...
        <tbody>
        @php
            $courses=\App\Models\Downloads::query();
 ...
 @endphp
        ...
        @foreach($courses as $course)
            <tr>
                ...
                <td>
                    <a download href="{{Storage::url($course->file)}}" class="btn btn-sm btn-warning"><span class="fa fa-download"></span> Download </a>
                </td>
                <td>
                    {{$course->views}}
                </td>
                ...
                <td>
                        <a href="/downloads/delete/{{$course->id}}" class="btn btn-danger btn-sm">Delete</a>
                </td>
            </tr>
        @endforeach
        </tbody>
