            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-sm-auto">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Semesters</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row d-flex justify-content-evenly mb-4">
        ...
        <div class="col-md-12 col-4 text-end">
            @if(isset($_GET['search']))
                <a class="btn btn-danger" href="/semesters">
                    Clear Search
                </a>
            @endif
            <a  class="btn btn-danger" href="#" data-bs-target="#newSem" data-bs-toggle="modal">New Semester</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="dt-responsive table-responsive overflow-scroll">
            <table id="cbtn-selectors" class="table table-striped nowrap">
                ...
                <tbody>
                @php
                    $courses=\App\Models\Semester::query();
                    ...
                    <tr>
                        ...
                        <td>
                            @if($course->status=='Inactive')
                                <a href="/semesters/activate/{{$course->id}}" class="btn btn-success btn-sm">Activate</a>
                            @else
                                <a href="/semesters/deactivate/{{$course->id}}" class="btn btn-danger btn-sm">Deactivate</a>
                            @endif
                        </td>
                    </tr>
                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="/semester/create">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="text-end m-2">
                            <button class="btn btn-danger">Create Semester</button>
                        </div>
                    </form>
                </div>
            </div>
