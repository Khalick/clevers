...
<div class="dt-responsive table-responsive">
    <table id="cbtn-selectors" class="table table-striped nowrap">
        ...
        <tbody>
        @php
            $applications=\App\Models\Student::query();
            $applications=$applications->where('status','!=','Graduated');
 ...
 @endphp
        ...
        @foreach($applications as $application)
            <tr>
                ...
                <td>
                    <a href="/students/details/{{$application->id}}" class="btn btn-sm btn-info">Details</a>
                    <a href="/students/reset/{{$application->email}}" class="btn btn-sm btn-warning">Reset Account</a>
                    @if($application->status =='Active')
                    <a href="/students/delete/{{$application->id}}" class="btn btn-sm btn-danger">Deactivate</a>
                    @else
                        <a href="/students/activate/{{$application->id}}" class="btn btn-sm btn-success">Activate</a>
                    @endif
