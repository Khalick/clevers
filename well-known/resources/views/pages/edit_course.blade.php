            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-auto">
                    <div class="page-header-title">
                        <h5 class="mb-0">Edit Course ->{{$course->title}}</h5>
                    </div>
                </div>
                <div class="col-sm-auto">
                    <ul class="breadcrumb">
...
@section('content')
    <div class="row">
        <form method="post" action="/course/edit" onsubmit="return setBlogData()">
            @csrf
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#courseAccordion">
                        ...
                        <div class="row d-flex justify-content-evenly">
                            <div class="mb-4 col-md-6">
                                ...
                                <input class="form-control" value="{{$course->code}}" name="code" id="code" type="text" maxlength="255" required>
                            </div>
                            <div class="mb-4 col-md-6">
                                <label for="title" class="form-label">
                                    Course Title
                                </label>
                                <input class="form-control" value="{{$course->title}}" name="title" id="title" type="text" maxlength="255" required>
                            </div>
                            <div class="mb-4 col-md-12">
                                ...
                                <div class="form-control" id="blog">{!! $course->description !!}</div>
                            </div>
                            <div class="mb-4 col-md-6">
                                <label for="duration" class="form-label">
                                    Course Duration
                                </label>
                                <input class="form-control" value="{{$course->duration}}" name="duration" id="duration" type="text" maxlength="255" required>
                            </div>
                            <div class="mb-4 col-md-6">
                                <label for="lecs" class="form-label">
                                    Total Lectures
                                </label>
                                <input class="form-control" value="{{$course->lecs}}" name="lecs" id="lecs" type="number" maxlength="100" required>
                            </div>
                            <div class="mb-4 col-md-4">
                                <label for="title" class="form-label">
                                    Has Certificate
                                </label>
                                <input @checked($course->certificate=='on') class="form-check" name="certificate" id="certificate" type="checkbox" required>
                            </div>
                            <div class="mb-4 col-md-4">
                                <label for="fees" class="form-label">
                                    Total Fees
                                </label>
                                <input class="form-control" value="{{$course->fees}}" name="fees" id="fees" type="number" required>
                            </div>
                            <div class="mb-4 col-md-4">
                                <label for="grade" class="form-label">
                                   Entry Grade
                                </label>
                                <input class="form-control" value="{{$course->grade}}" name="grade" id="grade" type="text" required>
                            </div>
                        </div>
                         </div>
                    </div>
                    ...
                    <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#courseAccordion">
                        <div class="accordion-body row">
                            ...
                            <div class="mb-4 col-md-6">
                                ...
                                <input id="video" value="{{$course->video}}" type="url" class="form-control" name="video">
                            </div>
                    ...
                    <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#courseAccordion">
                        <div class="accordion-body row">
                            <div class="mb-4 col-md-6">
                                ...
                                <input id="curriculum" type="file" class="curriculum" name="curriculum" accept="application/pdf" data-max-file-size="10MB" data-max-files="1">
                            </div>
                            <div class="mb-4 col-md-6">
                                @php
                                ...
                                @foreach($categories as $category)
                                       <option @selected($course->category==$category->name) value="{{$category->name}}">{{$category->name}}</option>
