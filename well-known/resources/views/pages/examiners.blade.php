            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-sm-auto">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Examination Bodies</li>
                    </ul>
                </div>
            </div>
        </div>
...
@section('content')
    <div class="row d-flex justify-content-evenly mb-4">
        ...
        <div class="col-md-12 col-4 text-end">
            @if(isset($_GET['search']))
                <a class="btn btn-danger" href="/examiners">
                    Clear Search
                </a>
            @endif
    ...
    <div class="row">
        @php
            $categories=\App\Models\Examiner::query();
        ...
        @foreach($categories as $category)
            @include('partials.examiner_item',['category'=>$category])
        @endforeach
        {{$categories->links()}}
    </div>

    @include('partials.new_examiner')
@endsection
