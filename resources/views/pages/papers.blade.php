                ...
                <div class="col-xl-12">
                    <div class="breadcrumb__content__wraper">
                        <div class="breadcrumb__title">
                            <h2 class="heading">Past Papers</h2>
                        </div>
...
@php
    $papers=\App\Models\PastPaper::query();
    if (!empty($_GET['search'])){
        $papers=$papers->where('subject','like','%'.$_GET['search'].'%');
    }
                ...
                <div class="col-md-6">
                    <div class="alert alert-info m-2">
                        <div class="alert-heading">
                            No past papers available yet. Please check again later
                        </div>
                    </div>
                </div>
            @endif
...
<div class="gridarea__content">
    <div class="gridarea__heading w-100">
        <h6><a href="https://admin.clevers.co.ke/storage/{{$paper->file}}" download>{{$paper->subject}}</a> </h6>
    </div>
