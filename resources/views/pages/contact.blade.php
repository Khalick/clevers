                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="single__contact">
                            ...
                            <div class="contact__text">
                                ...
                                <div class="contact__email">
                                    <p>Mitihani house 3rd floor</p>
                                    <span>Along Mfangano Street opposite KNUT HOUSE</span>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="contact__form__inner">
                            ...
                            <form id="contact-form"  class="contact-form" action="/contact/email" method="post">
                                @csrf
                                <div class="row">

                                    <div class="col-xl-6" data-aos="fade-up">
                                        <div class="contact__input__wraper">
                                            <input type="text" required name="name" id="con_name" placeholder="Enter Your Name*">
                                            <div class="contact__icon">
                                    ...
                                    <div class="col-xl-6" data-aos="fade-up">
                                        <div class="contact__input__wraper">
                                            <input type="text" required name="email" id="con_email" placeholder="Enter Email Address*">
                                            <div class="contact__icon">
                                    ...
                                    <div class="col-xl-12" data-aos="fade-up">
                                        <div class="contact__input__wraper">
                                            <textarea name="message" id="con_message" cols="30" rows="10" placeholder="Enter Your Message here"></textarea>
                                            <div class="contact__icon">
                                    ...
                                    <div class="col-xl-12" data-aos="fade-up">
                                        <div class="contact__button">
                                            ...
                                            <button type="submit" value="submit" class="default__button" name="submit">Submit Message</button>
